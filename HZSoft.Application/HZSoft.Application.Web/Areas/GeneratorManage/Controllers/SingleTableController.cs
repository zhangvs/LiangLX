...
using HZSoft.CodeGenerator;
using HZSoft.CodeGenerator.Model;
using HZSoft.CodeGenerator.Template;
using HZSoft.Util;
using System;
...
namespace HZSoft.Application.Web.Areas.GeneratorManage.Controllers
{
    /// <summary>
    /// 版 本 6.1
    /// 
