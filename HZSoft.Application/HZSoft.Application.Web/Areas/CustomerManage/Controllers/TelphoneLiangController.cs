...
namespace HZSoft.Application.Web.Areas.CustomerManage.Controllers
{
    ...
    public class TelphoneLiangController : MvcControllerBase
    {
        ...
        /// <returns></returns>
        [HttpGet]
        public ActionResult TelphoneLiangIndexJoin()
        {
            return View();
        }
        /// <summary>
        ...
        public ActionResult GetPageListJsonJoin(Pagination pagination, string queryJson)
        {
            var watch = CommonHelper.TimerStart();
            var data = telphoneliangbll.GetPageListJoin(pagination, queryJson);
            var jsonData = new
            {
                rows = data,
                total = pagination.total,
        ...
        [HttpGet]
        public ActionResult TelphoneLiangOrg(int? keyValue)
        {
            var data = telphoneliangbll.GetEntity(keyValue);
            return ToJsonResult(data);
        }
        ...
        {
            telphoneliangbll.MiaoShaForm(keyValues);
